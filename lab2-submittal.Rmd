...
cluster_data_3 <- ds_scaled[, c("median_age", "infection_rate")]
...
cluster_data_age_infection <- cluster_data_3[, c("median_age", "infection_rate")]
...
cluster_data_age_death <- cluster_data[, c("median_age", "death_rate")]
...
fviz_dend(hc_age_death, k = 3, 
          ...
          xlab = "", ylab = "Height", sub = "",
          k_colors = c("#1b9e77", "#d95f02", "#7570b3"),  # Custom colors for clusters
          rect = TRUE, rect_border = "black", rect_fill = FALSE) +
  labs(caption = "Figure 3.4.3") +
  theme(plot.caption = element_text(hjust = 0, size = rel(0.8)))
